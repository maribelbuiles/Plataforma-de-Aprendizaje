    ...
    if modulo == "Módulo 1: Equipo de Canastas Aptas":
        ...
        with tab1:
            ...
            with col_a:
                ...
                * **Separador Ovoid:** 8 kg[cite: 2].
                """)
            with col_b:
                st.info("""
                * **Estiba Ovoid:** 11 kg[cite: 2].
                * **Gancho Metálico:** 0.1 kg[cite: 2].
                """)
            ...
            * **Talla JUMBO:** 120 unidades sueltas (no cuenta con opción de amarrado)[cite: 2].
            """)
            st.write("Dimensiones de referencia para la manipulación: Canasta Kikes (63x32x23 cm)[cite: 2], Separadores Ovoid (124 cm x 66 cm)[cite: 2] y Estibas Ovoid (124 cm x 66 cm)[cite: 2].")
        ...
        with tab3:
            ...
            3. **Aplicación de Vinipel:** Instalar el vinipel desde el taco base de la estiba aplicando **dos vueltas completamente tensadas**[cite: 2]. Las vueltas consecutivas (3ª, 4ª y 5ª) se deben aplicar de forma ascendente en **forma de corbatín** para asegurar la ventilación del huevo[cite: 2].
            """)
    ...
    # =========================================================
        ...
        * **Protección de extremidades:** Bota plástica blanca de caña alta equipada con puntera de seguridad[cite: 1].
        ...
        with col_e:
            ...
            4. **Aplicación:** Esparcir la mezcla homogénea con el espumador mecánico y **permitir un tiempo de acción de 10 minutos**[cite: 1].
