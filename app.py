...
if st.session_state['cedula'] is None:
    ...
    # --- ENUNCIADO DE EVALUACIÓN Y CERTIFICADO EN EL LADO IZQUIERDO (SIDEBAR) ---
    st.sidebar.markdown("---")
    st.sidebar.markdown("### 📝 Evaluación")
    st.sidebar.markdown("### 🎓 Certificado")
    ...
    if modulo == "Módulo 1: Equipo de Canastas Aptas":
        ...
        # --- EVALUACIÓN Y CERTIFICADO GENERADOS CENTRALMENTE ABAJO EN EL MÓDULO 1 ---
        st.markdown("---")
    ...
    # --- CONTENIDO MÓDULO 2 ---
        ...
        # --- EVALUACIÓN Y CERTIFICADO GENERADOS CENTRALMENTE ABAJO EN EL MÓDULO 2 ---
        st.markdown("---")
    ...
    # --- CONTENIDO MÓDULO 3 ---
        ...
        # --- EVALUACIÓN Y CERTIFICADO GENERADOS CENTRALMENTE ABAJO EN EL MÓDULO 3 ---
        st.markdown("---")
